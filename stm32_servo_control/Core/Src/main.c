...
//	  htim2.Instance->CCR1 = 25;  // duty cycle is .5 ms // where 0 degree turn
//	  HAL_Delay(1000);
	  ...
	  HAL_Delay(500);
	  htim2.Instance->CCR1 = 175;  // duty cycle is 3.5 ms
	  HAL_Delay(500);
	  htim2.Instance->CCR1 = 225;
	  HAL_Delay(500);
	  htim2.Instance->CCR1 = 275; // duty cycle is 4.5 ms
	 /* USER CODE END WHILE */
